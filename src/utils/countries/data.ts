interface GeoBounds {
  ...
  export interface Country {
    ...
    vehicle_registration_code?: string;
    world_region: string;
    vat_rates?: VatRates;
    g20_member?: boolean;
    g7_member?: boolean;
    ...
    eu_member?: boolean;
    esm_member?: boolean;
    euvat_member?: boolean;
    nanp_prefix?: string;
  }
// 加载所有国家的JSON数据
export const countriesData: { [geoCode: string]: Country } = {
      "AD": {
        "alpha2": "AD",
        "alpha3": "AND",
        "continent": "Europe",
